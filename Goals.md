(This is a current collection of potential goals for the conversation with the co-developers or LLMs. The overlap with TODO.md is intentional, the latter being more of a scratchpad.)
...
## Engine Workflow Simplification (New)
